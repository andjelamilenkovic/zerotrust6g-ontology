# zerotrust6g-ontology 
Supplementary material for the paper "Ontology-Grounded Zero Trust Access Control for Agentic Systems in 6G Networks". 
## Contents 
- `ontology/` - OWL 2 ontology (zerotrust6g_taxonomy.owl, .ttl)
- `scripts/` - evaluation scripts:
  -  `proof_of_concept.py` - Configuration A (rule-based baseline, Table II)
  -  `zerotrust_latency_runs.py` - Configurations A-D, clinical monitoring benchmark, latency + accuracy
